...
<body>
    ...
    <div class="big-sidebar">
        <div class="left-sidebar">
            ...
            <li>
                <a class="current" href="view_outpatient.php">
                    <i class="fa fa-user "> </i>
                    <p>OutPatient</p> 
                </a>
            </li>
            ...
            <div class="main-wrapper">
                ...
                <div class="tablelist">  
                    ...
                    <div class="table-wrapper" id="display1">
                        ...
                        <?php
                            ...
                            while ($row = mysqli_fetch_array($response)) {
                                ...
                                '<td>'.$row['outp_gender'].'</td>'.
                                '<td>'.$row['outp_bloodgroup'].'</td>'.
                                '<td>'.$row['outp_birthdate'].'</td>';
                                echo'<td>
                    ...
                    <div class="table-wrapper" id="display2">
                        <form class="adding-form" action="includes/insertOutpatient.php" method="POST" enctype="multipart/form-data">
                            <div>
                            ...
                            <div class="table-footer">
                                <div class="table-footer-btn">
                                    <input type="submit" name="submit" id="submit" value="Add Outpatient">
                                </div>
                            </div>
                        </form>
                    </div>
