...
<!-- <h1>Welcome to the Admin Page</h1> -->
    ...
    <nav class="big-sidebar">
        <div class="left-sidebar">
            ...
            <li>
                <a class="current" href="manage_nurse.php">
            ...
            <li class = "has-sub"><a href="#"><i class="fa fa-wrench "></i><p>Settings</p><i class = "fa fa-arrow"></i></a>
                <ul>
                    ...
                    <li><a href=""><i class = "fa fa-download"></i><p>Backup Restore</p></a></li>
                </ul>
            </li>
        ...
        <div class="main-content">
            <div class="main-wrapper">
                ...
                <div class="tablelist">  
                    ...
                    <!-- <button id="vTab1">Tab1</button>
                    <button id="vTab2">Tab2</button> -->
                    <!-- <br>
                    <br> -->
                    <!-- //FIRST TAB -->
                    <div id="tab-hide1" class="table-tab" >
                        <li id="tab1" class="tab-one">
                            <div class="tab-on" href="">
                    ...
                    <div class="table-wrapper" id="display1">
                        ...
                        <?php
                            ...
                            $query = "SELECT * FROM t_nurse WHERE CONCAT(nu_lastname,' ',nu_firstname) LIKE '%$name%' ORDER BY NurseID ASC";
                            ...
                            while ($row = mysqli_fetch_array($response)) {
                                ...
                                echo '<td>'.$counter.'</td>';
                                echo
                                '<td>'.$row['nu_firstname'].'</td>'.
                                '<td>'.$row['nu_lastname'].'</td>'.
                                '<td>'.$row['nu_username'].'</td>';
                                echo   '<td>
                                            <div class = "table_btns">
                                                <div class = "updatebtn" onClick = "showUpdate(\''.$row['nu_firstname'].' '.$row['nu_lastname'].'\',\' '.$row['NurseID'].'\')" href="#">
                                                    <i class="fa fa-wrench"></i>
                                                </div>    
                                                <div class="delbtn" onClick="showDelete(\''.$row['nu_firstname'].' '.$row['nu_lastname'].'\',\''.$row['NurseID'].'\')" href="">
                                ...
                                //$fullname = $row['nurs_firstname'].' '.$row['nurs_lastname'];
                            }
                    ...
                    <div class="table-wrapper2" id="display2">
                        <form class="adding-form" action="includes/insertNurse.php" method="POST">
                            <div>
                                Firstname: <input type="text" name="fname" id="fname" placeholder="first name">
                                Lastname: <input type="text" name="lname" id="lname" placeholder="last name">
                            </div>
                            
                            <div>
                                Username: <input type="text" name="uname" id="uname" placeholder="uname">
                            ...
                            <div>
                                ...
                                Phoneno: <input type="text" name="phone" id="phone" placeholder = "phone number">
                            </div>
                            ...
                            <div class="table-footer">
                                <div class="table-footer-btn">
                                    <input type="submit" name = "submit" value="Add Nurse">
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class = "invisible_drop"></div>
                        ...
                        <div class = "update_invisible_drop"></div>
                            ...
                            <button Onclick = "x_btn" id = "x_btn"><i class = "fa fa-times "></i></button>
                                <form class="adding-form" action="includes/updateNurse.php" method="POST">
                                    <div>
                                    ...
                                    <div class="table-footer">
                                        <div class="table-footer-btn">
                                            <button type="submit" name="submit" id="submit">Update Nurse</button>
                                        </div>
    ...
    <script type="text/javascript" src="js/nurse.js"></script>
