...
<!-- <h1>Welcome to the Admin Page</h1> -->
    <header>
        ...
        <nav class="big-header">
            ...
            <div class = "loginuser">
                <?php
                    //echo "<p> Welcome Admin ".$_SESSION['u_first']." ".$_SESSION['u_last']."</p>";
    ...
    <nav class="big-sidebar">
        <div class="left-sidebar">
            ...
            <li>
                <a class="current"  href="manage_pharmacist.php">
            ...
            <div class="main-wrapper">
                ...
                <div class="tablelist">  
                    ...
                    <div class="table-wrapper" id="display1">
                            ...
                            <div id = "pharmacist">
                                <?php
                                    ...
                                    $query = "SELECT * FROM t_pharmacist WHERE CONCAT(ph_lastname,' ',ph_firstname) LIKE '%$name%' ORDER BY PharmacistID ASC";
                                    ...
                                    while ($row = mysqli_fetch_array($response)) {
                                        ...
                                        echo '<td>'.$counter.'</td>';
                                        echo
                                        '<td>'.$row['ph_firstname'].'</td>'.
                                        '<td>'.$row['ph_lastname'].'</td>'.
                                        '<td>'.$row['ph_username'].'</td>';
                                        echo   '<td>
                                                    <div class = "table_btns">
                                                        <div class = "updatebtn" onClick = "showUpdate(\''.$row['ph_firstname'].' '.$row['ph_lastname'].'\',\' '.$row['PharmacistID'].'\')" href="#">
                                                            <i class="fa fa-wrench"></i>
                                                        </div>    
                                                        <div class="delbtn" onClick="showDelete(\''.$row['ph_firstname'].' '.$row['ph_lastname'].'\',\''.$row['PharmacistID'].'\')" href="">
                    ...
                    <div class="table-wrapper" id="display2">
                        <form class="adding-form" action="includes/insertPharmacist.php" method="post">
                            <div>
                    ...
                    <div class = "invisible_drop"></div>
                        ...
                        <div class = "update_invisible_drop"></div>
                            ...
                            <button Onclick = "x_btn" id = "x_btn"><i class = "fa fa-times "></i></button>
                                <form class="adding-form" action="includes/updatePharmacist.php" method="POST">
                                    <div>
                                    ...
                                    <div class="table-footer">
                                        <div class="table-footer-btn">
                                            <button type="submit" name="submit" id="submit">Update Pharmacist</button>
                                        </div>
    ...
    <script type="text/javascript" src="js/pharmacist.js"></script>
