...
<!-- <h1>Welcome to the Admin Page</h1> -->
    ...
    <nav class="big-sidebar">
        <div class="left-sidebar">
            ...
            <li>
                <a class = "current" href="manage_department.php">
            ...
            <div class="main-wrapper">
                ...
                <div class="tablelist">  
                    ...
                    <div class="table-wrapper" id="display1">
                            ...
                            <div id = "departments">
                                <?php
                                    ...
                                    $query = "SELECT * FROM t_department WHERE dep_name LIKE '%$name%' ORDER BY DepartmentID ASC";
                                    ...
                                    while ($row = mysqli_fetch_array($response)) {
                                        ...
                                        echo   '<td>
                                                    <div class = "table_btns">
                                                        <div class = "updatebtn" onClick="showUpdate(\''.$row['dep_name'].' '.$row['dep_description'].'\',\''.$row['DepartmentID'].'\')" href="#">
                    ...
                    <div class="table-wrapper" id="display2">
                            ...
                            <form class="adding-form" action="includes/insertDepartment.php" method="POST">
                                <div>
                                    Department Name: <select name="deptname" id="deptname">
                                                        <option value="Cardiology">Cardiology</option>
                                                        <option value="Neurology">Neurology</option>
                                                        <option value="Pharmacy">Pharmacy</option>
                                                        <option value="ophthalmology">Ophthalmology</option>
                                                        <option value="surgery">Surgery</option>n>
                                                    </select>
                                </div>
                                    <br>
                                <div>
                                   Department Description: <br>  <textarea name="deptdesc" id="deptdesc" cols="30" rows="10" placeholder="Enter description"></textarea>
                                </div>

                                <div class="table-footer">
                                    <div class="table-footer-btn">
                                        <button Onclick = "submit" name = "submit" id = "submit" type="submit" value="Add Department">Add Department</button>
                                    </div>
                    ...
                    <div class = "invisible_drop"></div>
                        ...
                        <div class = "update_invisible_drop"></div>
                            ...
                            <button Onclick = "no_btn" id = "x_btn"><i class = "fa fa-times "></i></button>
                                <form class="adding-form" action="includes/updateDepartment.php" method="POST">
                                    <div>
                                        Department Name: <select name="deptname" id="deptname_up" >
                                                            <option value="cardiology">Cardiology</option>
                                                            <option value="neurology">Neurology</option>
                                                            <option value="pharmacy">Pharmacy</option>
                                                            <option value="ophthalmology">Ophthalmology</option>
                                        ...
                                        <br>
                                    <div>
                                    Department Description: <br>  <textarea name="deptdesc" id="deptdesc_up" cols="30" rows="10" placeholder="Enter description"></textarea>
                                    </div>
