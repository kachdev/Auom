    ...
    <nav class="big-sidebar">
        ...
        <div class="main-content">
            <div class="main-wrapper">
                    ...
                    <div class="table-wrapper" id="display1">
                        ...
                        <div id = "outpatient">
                            <?php
                                ...
                                $query = "SELECT * FROM t_outpatient WHERE CONCAT(outp_lastname,' ',outp_firstname) LIKE '%$name%' ORDER BY OutpatientID ASC";
                ...
                <div class="table-wrapper" id="display2">
                    <form class="adding-form" action="includes/insertOutpatient.php" method="post">
                        ...
                        <div>
                            DateofBirth <input type="date" name="dob" id="">
                ...
                <!-- <tbody>
                    <tr>
                        ...
                        <td>Francis</td>
                        <td>@Danifranci</td>
                        <td><a href="viewauser.html">View</a></td>
                    </tr>
            ...
            <!-- <div class="right-sidebar">
                <div class="cardimg">
                    <img src="image/wiz.jpg" alt="starboy">
                </div> <br>
                <div class="cardnote">
                    <h2>Ayo Balogun</h2>
                    <span>Username</span> 
                    <p>"Oya pick all my money put an for your head o, for your head ohoh oh mama mo
                        Oya pick all my money put am for your waist oh, for you waist ohoh oh"</p>
                </div>
            </div> -->
        </div>
    </nav>
