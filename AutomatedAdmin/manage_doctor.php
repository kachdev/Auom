...
;            </div> -->
    ...
    <nav class="big-sidebar">
        <div class="left-sidebar">
            ...
            <li>
                <a class="current"  href="manage_doctor.html">
            ...
            <div class="main-wrapper">
                ...
                <div class="tablelist">  
                    ...
                    <div class="table-wrapper" id="display1">
                            ...
                            <div id = "doctor">
                                <?php
                                    ...
                                    $query = "SELECT * FROM t_doctor WHERE CONCAT(d_lastname,' ',d_firstname) LIKE '%$name%' ORDER BY DoctorID ASC";
                                    ...
                                    while ($row = mysqli_fetch_array($response)) {
                                        ...
                                        echo   '<td>
                                                    <div class = "table_btns">
                                                        <div class = "updatebtn" onClick = "showUpdate(\''.$row['d_firstname'].' '.$row['d_lastname'].'\',\' '.$row['DoctorID'].'\')" href="#">
                    ...
                    <div class="table-wrapper" id="display2">
                        <form class="adding-form" action="includes/insertDoctor.php" method="POST" >
                            <div>
                            ...
                            <div>
                                ...
                                Phoneno: <input type="text" name="phone" id="">
                            </div>
                            ...
                            <div>
                                ...
                                Profile <input type="text" name="profile" id="" placeholder="profile">
                            </div>

                            <div class="table-footer">
                                <div class="table-footer-btn">
                                    <button type="submit" name="submit" id="submit" value="Add Doctor">Add Doctor</button>
                                </div>
...
<!-- UPDATE MODAL -->
                        ...
                        <div class = "update_invisible_drop"></div>
                            ...
                            <button Onclick = "x_btn" id = "x_btn"><i class = "fa fa-times "></i></button>
                                <form class="adding-form" action="includes/updateDoctor.php" method="POST">
                                <input type="hidden" name="doc_id" id="doc_idup" readonly required >
                                    <div>
                                    ...
                                    <div>
                                        Department: <select name="dept_up" id="dept_up">
                                                        <option value="">Select Department</option>
                                                        <option value="cardiology">Cardiology</option>
                                                        <option value="neurology">Neurology</option>
                                                        <option value="pharmacy">Pharmacy</option>
                                        ...
                                        Profile <input type="text" name="profile" id="profile_up" placeholder="profile">
                                    </div>

                                    <div class="table-footer">
                                        <div class="table-footer-btn">
                                            <button type="submit" name="update_doctor" id="submit" value="Update Doctor">Update Doctor</button>
                                        </div>
