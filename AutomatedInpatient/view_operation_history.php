...
<body>
            ...
            <div class="adminlogout-btn" >
                <?php
                    if (isset($_SESSION['in_id'])) {
                        ...
                        header("Location: inpatientlogin.php?Logout=success");
                        exit();
                    }
                ?>
            </div>
    ...
    <nav class="big-sidebar">
        <div class="left-sidebar">
            ...
            <li>
                <a class="current" href="view_operation_history.php">
                ...
                <div class="tablelist">  
                    ...
                    <div class="table-wrapper" id="display1">
                        ...
                        <?php
                            ...
                            $query = "SELECT * FROM t_report WHERE InpatientID = '".$_SESSION['in_id']."'";
