                ...
                <div class="tablelist">  
                    ...
                    <div class="table-wrapper" id="display1">
                        ...
                        <?php
                            ...
                            $query = "SELECT * FROM t_bedallotment WHERE InpatientID = '".$_SESSION['in_id']."'"; 
                            // CONCAT(inp_firstname,' ',inp_lastname) AND ad_bednumber LIKE '%$name%' ORDER BY AdmitHistoryID ASC
