                    ...
                    <div class = "update_invisible_drop"></div>
                        ...
                        <button Onclick = "x_btn" id = "x_btn"><i class = "fa fa-times "></i></button>
                            <form class="adding-form" action="includes/updateInpatient.php" method="POST">
                                ...
                                <div>
                                    Firstname: <input type="text" name="fname" id="fname_up" placeholder="firstname" required>
                                    Lastname: <input type="text" name="lname" id="lname_up" placeholder="lastname"required>
                                </div>

                                <div>
                                    Username: <input type="text" name="uname" id="uname_up" placeholder="username"required>
                                    Password: <input type="password" name="pwd" id="pwd_up" placeholder="password"required>
                                </div>

                                <div class="address-flex">
                                    Email: <input type="email" name="email" id="email_up" placeholder = "email" required>
                                </div>

                                <div>
                                    Gender: <select name="gen" id="gen_up" value="Male" required>
                                                <option value="male" >Male</option>
                                                <option value="female">Female</option>
                                            </select>
                                    Phoneno: <input type="text" name="phone" id="phone_up" required>
                                </div>

                                <div class="address-flex">
                                    Address: <input type="text" name="address" id="address_up" required>
                                </div>

                                <div>
                                    DateofBirth <input type="date" name="date" id="dob_up" required>
                                    Occupation <input type="text" name="occupation" id="occupation_up" required>
                                    
                                </div>

                                <div>
                                    MaritalStatus <select name="status" id="status_up" required>
                                                    <option value="single">Single</option>
                                                    <option value="married">Married</option>
                                                </select>
                                    
                                        BloodGroup <select name="blood" id="blood_up" required>
                                        <option value="A+">A+</option>
                                        <option value="A-">A-</option>
                                        <option value="B+">B+</option>
                                        <option value="B-">B-</option>
                                ...
                                <div>
                                    Nextofkin <input type="text" name="kin" id="kin_up" placeholder = "Next of kin" required>
                                    Nextofkinphoneno <input type="text" name="kphone" id="kinno_up" required>
                                </div>
