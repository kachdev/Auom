        ...
        <div class="main-content">
            <div class="main-wrapper">
                ...
                <div class="tablelist">  
                    ...
                    <div class="table-wrapper" id="display1">
                        ...
                        <?php
                            ...
                            $query = "SELECT * FROM t_prescription  ORDER BY PrescriptionID ASC";
                ...
                <div class="table-wrapper" id="display2">
                    <form class="adding-form" action="includes/insertPrescription.php" method="post">
                        <div class = "flexrow">
                            <div class = "column">
                                <div>
                                    <label for="">Doctor</label>
                                    <input type="text" name="dname" id="" value = "<?php echo $details['d_firstname'].' '.$details['d_lastname']; ?>" placeholder="Doctor Name" readonly>  
                                </div>
                            </div>
                        ...
                        <div class = "flexrow">
                            ...
                            <select name="pname" id="pname" placeholder = "Patient Name">
                                <?php
                                    $querydoctors = "SELECT * FROM t_outpatient";
                                    $result2 = mysqli_query($connect, $querydoctors);
                                    if($result2){
                                        while($row = mysqli_fetch_array($result2))
                                        {                                            
                                            echo '<option>'.$row['outp_firstname'].' '.$row['outp_lastname'].'</option>';
                                        }
                                    }else{
                                        echo "<div>error".mysqli_error($connect)."</div>";
                                    }
                        ...
                        <div class = "flexrow">
                            <div class = "column2"> 
                                <div>
                                    ...
                                    <textarea name="case" id="case"  placeholder = "Enter case history"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class = "flexrow">
                            <div class = "column">
                                <div>
                                    ...
                                    <input type="text" name="med" id="" placeholder = "Medication">
                                </div>
                            </div>

                            <div class = "column">
                                <div>
                                    <label for="">Pharmacist Medication</label>
                                    <input type="text" name="phmed" id="" placeholder = "pharmacist medication">
                                </div>  
                            </div>
                        </div>
